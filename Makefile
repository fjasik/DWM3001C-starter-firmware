...
build: development-environment
	docker run -v "C:\Users\Pingwin\code\DWM3001C-starter-firmware":/project uberi/qorvo-nrf52833-board /usr/local/segger_embedded_studio_V5.42a/bin/emBuild -config "Common" /project/dw3000_api.emProject

# remove all build outputs from the project (you may want to run this if you run into issues with stale interfaces)
clean: development-environment
	docker run -v "C:\Users\Pingwin\code\DWM3001C-starter-firmware":/project uberi/qorvo-nrf52833-board /usr/local/segger_embedded_studio_V5.42a/bin/emBuild -config "Common" -clean /project/dw3000_api.emProject
...
flash: development-environment
	docker run --privileged  -v /dev/bus/usb/:/dev/bus/usb -v "C:\Users\Pingwin\code\DWM3001C-starter-firmware/Output":/project/Output:ro uberi/qorvo-nrf52833-board nrfjprog --force -f nrf52 --program /project/Output/Common/Exe/dw3000_api.hex --sectorerase --verify
...
stream-debug-logs:
	...
	docker run --privileged -it -v /dev/bus/usb:/dev/bus/usb -v "C:/Users/Pingwin/code/DWM3001C-starter-firmware/Output":/project/Output uberi/qorvo-nrf52833-board /usr/local/JLink_Linux_V792n_x86_64/JLinkRTTLogger -Device NRF52833_XXAA -if SWD -Speed 4000 -RTTChannel 0 /project/Output/debug-log.txt
...
development-shell: development-environment
	docker run -it -v "C:\Users\Pingwin\code\DWM3001C-starter-firmware":/project uberi/qorvo-nrf52833-board
