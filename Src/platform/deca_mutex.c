...
//     If HW port uses EXT_IRQ line to receive ready/busy status from DW3000
//     then mutex should use this signal If HW port not use EXT_IRQ line (i.e.
//     SW polling) then no necessary for decamutex(on/off)
//
// ---------------------------------------------------------------------------
 ...
 */
void decamutexoff(
    decaIrqStatus_t s) // put a function here that re-enables the interrupt at
