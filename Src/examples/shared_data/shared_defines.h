...
#define TX_CHANGEABLE_DATA                                                     \
    (10) /*Can change the length of TX data by this size*/
#define MINIMAL_DATA_LENGTH                                                    \
    (11) /*The TX length will be at least the buffer below*/
#define SIMPLE_TX_DATA_SIZE (MINIMAL_DATA_LENGTH + TX_CHANGEABLE_DATA)
#define TX_LENGTH_BYTE_POS                                                     \
    (2) /*This byte index represent the total length of the TX data*/
