...
#include <deca_device_api.h>
     ...
     * calculate response timestamp and send delayed response with timestamp
     * will be different for each device. Adjusting this value lower and lower
     * until dwt_starttx() starts returning DWT_ERROR status allows the user to
     * tweak their system to calculate the shortest turn-around time for
     * messages.
     */
     ...
     * ~10% of ranging attempts have a larger than usual difference between
     * Ipatov and STS. A larger threshold allows for better coverage with this
     * coverage. This should be fixed for DW3000 C0 devices.
     */
 ...
 * Channel 5, PRF 64M, Preamble Length 64, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_17

/* Configuration option 18.
 * Channel 9, PRF 64M, Preamble Length 64, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_18

/* Configuration option 19.
 * Channel 5, PRF 64M, Preamble Length 128, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_19

/* Configuration option 20.
 * Channel 9, PRF 64M, Preamble Length 128, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
 ...
 * Channel 9, PRF 64M, Preamble Length 512, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_22

/* Configuration option 23.
 * Channel 5, PRF 64M, Preamble Length 1024, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_23

/* Configuration option 24.
 * Channel 9, PRF 64M, Preamble Length 1024, PAC 8, Preamble code 9, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_24

/* Configuration option 25.
 * Channel 5, PRF 64M, Preamble Length 64, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_25

/* Configuration option 26.
 * Channel 9, PRF 64M, Preamble Length 64, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_26

/* Configuration option 27.
 * Channel 5, PRF 64M, Preamble Length 128, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_27

/* Configuration option 28.
 * Channel 9, PRF 64M, Preamble Length 128, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_28

/* Configuration option 29.
 * Channel 5, PRF 64M, Preamble Length 512, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_29

/* Configuration option 30.
 * Channel 9, PRF 64M, Preamble Length 512, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_30

/* Configuration option 31.
 * Channel 5, PRF 64M, Preamble Length 1024, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
// #define CONFIG_OPTION_31

/* Configuration option 32.
 * Channel 9, PRF 64M, Preamble Length 1024, PAC 8, Preamble code 10, Data
 * Rate 6.8M, STS Length 64
 */
